...
export const About = () => {
  return (
    <div className="w-full flex justify-center">
            <div className="text-white px-5 min-h-[80vh] sm:pt-0 sm:flex sm:flex-col sm:px-28 lg:px-40 2xl:px-72 mb-20">
                ...
                <div className="flex flex-col md:flex-row justify-center items-center">
                    <div className='mb-20 md:mb-0 md:flex-[0.5_1_0%] w-[50%] md:w-full relative justify-center'>
