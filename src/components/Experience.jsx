...
const experienceList = [
    {id:'exp-1', img: QalltaLogo, company:'Qallta Software', description:'Desarrollo, mantenimiento e integración de soluciones tecnológicas', job:'FullStack Developer', techStack: ['React Js', 'Node Js', '.Net 7', 'SQL Server', 'API REST', 'Material UI', 'Jest', 'Vitest', 'Docker', 'Next js']},
    ...
    {id:'exp-3', img: LoyaltyLogo, company:'Loyalty Clubs', description:'Desarrollo, mantenimiento e integración de aplicaciones mobiles para Android y IOS', job:'Analista de Desarrollo', techStack: ['Flutter', 'Node Js', 'Express Js', 'Heroku', 'Sequelize', 'API REST', 'Cpanel', 'MySql', 'S3', 'Cloudinary']},
    {id:'exp-4', img: UtepsaLogo, company:'UTEPSA', description:'Desarrollo de aplicaciones Web.', job:'Desarrollador, Aux. de Sistemas', techStack: ['React Js', 'Node Js', 'Express Js', 'Heroku', 'API REST', 'MySql', 'Cloudinary']}
]
...
export const Experience = () => {
    ...
    return (
        <div className="w-full flex justify-center">
            <div className="text-white px-5 min-h-screen sm:pt-0 sm:flex sm:flex-col md:px-24 lg:px-40 2xl:px-72">
                ...
                <div className="flex flex-wrap justify-evenly">
                    {experienceList.map(exp => (
                        <div key={exp.id} className="shadow-md shadow-teal-800 mb-6 inline-block border-teal-100 border-opacity-10 sm:w-[45%] md:w-[48%] hover:scale-105 transition duration-300 break-words rounded-lg p-4 font-sans text-sm font-normal text-blue-gray-500 focus:outline-none">
