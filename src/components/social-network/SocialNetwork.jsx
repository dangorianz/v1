...
export const SocialNetwork = () => {
  return (
    <div className="fixed -bottom-16 left-4 sm:bottom-0 sm:left-10 text-white font-bold social fade-in-info">
      <ul className="mb-5">
        <li className="mt-8 hover:text-teal-300 hover:-translate-y-2 duration-300 transition-all"><Link href="https://www.github.com/dangorianz" target="_blank"><RiGithubLine size={30}/></Link></li>
