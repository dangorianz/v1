    ...
    <main className="h-screen relative">
      ...
      <div className="text-white min-h-screen pt-40 sm:pt-0 sm:flex items-center px-5 sm:px-32 md:40">
          <div className="flex flex-col justify-center items-center sm:items-start pb-20">
            ...
            <p className="mt-10 text-center sm:text-start sm:max-w-[500px] animate__animated animate__fadeInDown animate__slow description-animation">I’m a software engineer specializing in building (and occasionally designing) exceptional digital experiences. Currently, I’m focused on building accessible, human-centered products at Upstatement.</p>
