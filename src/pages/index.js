...
import { Experience, Logo, Mail, NavBar, SocialNetwork } from "../components"
    ...
    <main className="h-screen relative">
      ...
      <div className="text-white min-h-screen pt-40 sm:pt-0 sm:flex 2xl:px-72 items-cente justify-center px-5 sm:px-30 md:40">
          <div className="flex flex-col justify-center items-center pb-20">
            ...
            <a className="w-fit animate__animated animate__fadeInDown animate__slow description-animation cursor-pointer" href='https://drive.google.com/file/d/1RNVOjaeZqsgsP0m6jCvx5R9LqmTw5WRp/view?usp=sharing' target='_blank' rel="noreferrer">
