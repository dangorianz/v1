...
const IndexPage = () => {
  ...
  return (
    <main className="h-screen relative">
      ...
      <Mail/>
      <NavBar />
      <div className="text-white min-h-screen pt-40 sm:pt-0 sm:flex 2xl:px-72 items-cente justify-center px-5 sm:px-32 md:40">
          <div className="flex flex-col justify-center items-center pb-20">
            <p className='text-teal-300 animate__animated animate__fadeInDown animate__slow'><Logo/></p>
            <p className="mt-5 text-6xl md:text-7xl font-bold text-slate-300 animate__animated animate__fadeInDown animate__slow"><span className="text-teal-300">D</span>aniel <span className="text-teal-300">G</span>orianz</p>
